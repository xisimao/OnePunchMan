...
HisiDecodeChannel::~HisiDecodeChannel()
{
#ifndef _WIN32
...
bool HisiDecodeChannel::InitHisi(int videoCount)
{
#ifndef _WIN32
...
void HisiDecodeChannel::UninitHisi(int videoCount)
{
#ifndef _WIN32
	//vedc
	for (int i = 0; i < videoCount; ++i) {
...
bool HisiDecodeChannel::YuvToIve()
{
#ifndef _WIN32
...
bool HisiDecodeChannel::SetTempIve(unsigned char taskId,const unsigned char* yuv, unsigned int frameIndex, unsigned char frameSpan, bool finished)
{
	if (_yuvHasValue)
	{
		return false;
...
FrameItem HisiDecodeChannel::GetTempIve()
{
	FrameItem item;
	if (_yuvHasValue)
	{
