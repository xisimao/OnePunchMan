...
void IVEHandler::HandleFrame(const unsigned char* ive, int width, int height, unsigned int frameIndex)
{
	...
	const uint8_t* b = ive;
	const uint8_t* g = b + width * height;
	const uint8_t* r = g + width * height;
