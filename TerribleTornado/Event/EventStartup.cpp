...
//
//const string EventStartup::EventTopic("Event");
//
...
//}
//
//void EventStartup::GetDevice(HttpReceivedEventArgs* e)
//{
...
//}
//
//void EventStartup::GetChannel(HttpReceivedEventArgs* e)
//{
...
//}
//
//void EventStartup::DeleteChannel(HttpReceivedEventArgs* e)
//{
//    string id = GetId(e->Url, "/api/channels");
//    int channelIndex = StringEx::Convert<int>(id);
//    FlowChannelData data;
...
//}
//
//void EventStartup::SetChannel(const FlowChannel& channel)
//{
...
//}
//
//void EventStartup::DeleteChannel(int channelIndex)
//{
//    lock_guard<mutex> lck(_decodeMutex);
...
//}
//
//string EventStartup::CheckChannel(const FlowChannel& channel)
//{
//    if (ChannelIndexEnable(channel.ChannelIndex))
//    {
//        return string();
...
//}
//
//string EventStartup::GetChannelJson(HttpReceivedEventArgs* e, const FlowChannel& channel)
//{
//    string channelJson;
...
//}
//
//bool EventStartup::ChannelIndexEnable(int channelIndex)
//{
//    return channelIndex >= 1 && channelIndex <= FlowChannelData::ChannelCount;
//}
//
//bool EventStartup::UrlStartWith(const string& url, const string& key)
//{
...
//}
//
//string EventStartup::GetId(const std::string& url, const std::string& key)
//{
//    return url.size() >= key.size() ? url.substr(key.size() + 1, url.size() - key.size() - 1) : string();
//}
//
//string EventStartup::GetErrorJson(const string& field, const string& message)
//{
//    return StringEx::Combine("{\"", field, "\":[\"", message, "\"]}");
//}
//
//void EventStartup::StartCore()
//{
//    while (!_cancelled)
//    {
