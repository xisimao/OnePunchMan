...
HI_VOID SAMPLE_COMM_VI_GetSensorInfo(SAMPLE_VI_CONFIG_S* pstViConfig)
{
    ...
    pstViConfig->astViInfo[1].stSnsInfo.enSnsType = 1;

    pstViConfig->astViInfo[2].stSnsInfo.enSnsType = 2;

    pstViConfig->astViInfo[3].stSnsInfo.enSnsType = 3;

    pstViConfig->astViInfo[4].stSnsInfo.enSnsType = 4;

    pstViConfig->astViInfo[5].stSnsInfo.enSnsType = 5;

    pstViConfig->astViInfo[6].stSnsInfo.enSnsType = 6;

    pstViConfig->astViInfo[7].stSnsInfo.enSnsType = 7;
}
