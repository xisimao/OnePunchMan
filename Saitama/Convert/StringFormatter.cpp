...
void StringFormatter::Serialize(string* buffer, bool value)
{
	buffer->push_back(value);
}

void StringFormatter::Serialize(string* buffer, float value)
{
	Float_Convert fc;
	fc.F = value;
...
void StringFormatter::Serialize(std::string* buffer, double value)
{
	Double_Convert dc;
	dc.D = value;
