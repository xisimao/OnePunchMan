...
namespace Saitama
{
	...
	public:
		...
		* @param: value 布尔类型
		*/
		static void Serialize(std::string* buffer, bool value);
		...
		* @param: value 单字节浮点类型
		*/
		static void Serialize(std::string* buffer, float value);
		...
		* @param: value 双字节浮点类型
		*/
		static void Serialize(std::string* buffer, double value);
